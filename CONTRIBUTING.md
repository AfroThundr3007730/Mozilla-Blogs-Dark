# Contributing to Mozilla-Blogs-Dark
...
There are a number of ways to get involved with the development of this Mozilla Blogs Dark theme. Even if you've never contributed to an Open Source project before, we're always looking for help identifying missing styles or other issues.
...
* [Download](https://github.com/AfroThundr3007730/Mozilla-Blogs-Dark/archive/master.zip), [fork](https://github.com/AfroThundr3007730/Mozilla-Blogs-Dark/fork) or clone this repository.
* Use [node.js](http://nodejs.org/) to run `npm install`.
* Make any changes to the `mozilla-blogs-dark.user.css` file and save.

### Build & test

* Create & change into a new branch of your local Mozilla-Blogs-Dark repository.
...
* Now you can add and commit the changes of the `mozilla-blogs-dark.user.css` file to your fork's branch.
